# 1 "../../Template_Codes/04-CLCD-Sources/4-BitDriver.X/clcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 295 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../Template_Codes/04-CLCD-Sources/4-BitDriver.X/clcd.c" 2
...
# 2 "../../Template_Codes/04-CLCD-Sources/4-BitDriver.X/clcd.c" 2
# 1 "../../Template_Codes/04-CLCD-Sources/4-BitDriver.X/clcd.h" 1
# 36 "../../Template_Codes/04-CLCD-Sources/4-BitDriver.X/clcd.h"
void init_clcd(void);
void clcd_putch(const char data, unsigned char addr);
void clcd_print(const char *str, unsigned char addr);
# 3 "../../Template_Codes/04-CLCD-Sources/4-BitDriver.X/clcd.c" 2
